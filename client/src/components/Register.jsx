...
const Register = () => {
  ...
  return (
                    ...
                    <div className="w-1/2 px-3 mb-2">
                      ...
                      <div className="flex">
                        ...
                        onChange={(e)=>setfName(e.target.value)}
                          type="text"
                          className={`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none focus:border-indigo-500 ${
                            errors && errors.fName ? 'border-red-500 border-[1.5px]' : 'border-gray-200'
                          }`}
                          placeholder="John"
                        />
                      </div>
                    ...
                    <div className="w-1/2 px-3 mb-2">
                      ...
                      <div className="flex">
                        ...
                        onChange={(e)=>setlName(e.target.value)}
                          type="text"
                          className={`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none focus:border-indigo-500 ${
                            errors && errors.lName ? 'border-red-500 border-[1.5px]' : 'border-gray-200'
                          }`}
                          placeholder="Smith"
                        />
                      </div>
                    ...
                    <div className="w-full px-3 mb-2">
                      ...
                      <div className="flex">
                        ...
                        onChange={(e)=>setEmail(e.target.value)}
                          type="email"
                          className={`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none focus:border-indigo-500 ${
                            errors && errors.email ? 'border-red-500 border-[1.5px]' : 'border-gray-200'
                          }`}
                    ...
                    <div className="w-full px-3 mb-2">
                      ...
                      <div className="flex">
                        ...
                        onChange={(e)=>setPassword(e.target.value)}
                          type="password"
                          className={`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none focus:border-indigo-500 ${
                            errors && errors.password ? 'border-red-500 border-[1.5px]' : 'border-gray-200'
                          }`}
                          placeholder="************"
                        />
                      </div>
                    ...
                    <div className="w-full px-3 mb-12">
                      ...
                      <div className="flex">
                        ...
                        onChange={(e)=>setcPassword(e.target.value)}
                          type="password"
                          className={`w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none focus:border-indigo-500 ${
                            errors && errors.cPassword ? 'border-red-500 border-[1.5px]' : 'border-gray-200'
                          }`}
                          placeholder="************"
                        />
                      </div>
      ...
      <p className="text-red-500 text-xs mt-1">{errors.cPassword}</p>
        ...
        <span className="text-gray-700 text-sm text-blue-700 font-semibold">
          <Link to="/">SignIn</Link>
        </span>
      </div>
                </div>
